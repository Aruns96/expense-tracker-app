...
const postForgotPassword = async(req,res)=>{
    try{
      ...
      if(user){
        ...
        sendSmtpEmail.htmlContent = `<a href="http://54.167.89.13:3000/password/resetpassword/${id}">reset password</a>`;
    ...
    try{
        ...
        const forgotpasswordrequest = await Forgotpassword.findOne({where:{id}}).then(forgotpasswordrequest=>{
            if(forgotpasswordrequest){
                ...
                <form action="http://54.167.89.13:3000/password/updatepassword/${id}" method="GET">
